...
const TestButton = (props) => {
  console.log(props)
    return(
        ...
        <Link to="/"><button onClick={props.handleLogout} className="test-logout-button" >Logout and Return to Login</button></Link>
        <Link to="/agenda"><button onClick={props.handleLogout} className="test-logout-button" >Head to Agenda</button></Link>
