...
function PreEvent(props) {
  ...
  const loggedIn = props?.location?.state?.loggedIn;
  if (!loggedIn) {
    console.log("PREEVENT - Not loggedIn");
    // Need to add a rediret here to some fallback page (i.e user not found)
    return null;
  }
  ...
  return (
    <div className="container">
      ...
      <div>{/* <ClientPendingBanner subject="confirmation"/> */}</div>
    </div>
  );
}
